...
/**
 * <p>
 * A {@link Filter} that enable client-side cross-origin requests by implementing W3C's CORS (<b>C</b>ross-<b>O</b>rigin
 * <b>R</b>esource
 * <b>S</b>haring) specification for resources. Each {@link HttpServletRequest} request is inspected as per
...
public final class CORSFilter implements Filter {
	...
	public static final Collection<String> COMPLEX_HTTP_METHODS
			= new HashSet<String>(
					Arrays.asList("PUT", "PATCH", "DELETE", "TRACE", "CONNECT"));
	/**
